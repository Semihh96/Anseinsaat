...
<head>
    ...
    <title>Anse Mimarlık İnşaat</title>
...
<div id="side-bar" class="side-bar">
    ...
    <div class="inner-main-wrapper-desk d-none d-lg-block">
        ...
        <div class="inner-content">
            <h4 class="title">Anse Mimarlık İnşaat</h4>
            <p class="disc">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
            <div class="footer">
                <h4 class="title">Lorem İpsum</h4>
                <a href="#" class="rts-btn btn-seconday">İletişim</a>
            </div>
        </div>
    </div>
    <div class="mobile-menu d-block d-xl-none">
        <nav class="nav-main mainmenu-nav mt--30">
            <ul class="mainmenu" id="mobile-menu-active">
                <li>
                    <a href="index.php" class="main">Anasayfa</a>
                </li>
                <li>
                    <a href="#" class="main">Hakkımızda</a>
                </li>
                <li>
                    <a href="#" class="main">Hizmetlerimiz</a>
                </li>
                <li>
                    <a href="#" class="main">Projeler</a>
                </li>
                <li>
                    <a href="#" class="main">Medya</a>
                </li>
                <li>
                    <a href="#" class="main">İletişim</a>
                </li>
            </ul>
        </nav>
                            ...
                            <div class="col-lg-12">
                                <div class="banner-one-wrapper ptb--110">
                                        <span class="b_one-pre">
                                            Hoşgeldiniz Anse Mimarlık İnşaat
                                        </span>
                                    ...
                                    <div class="button-area-banner">
                                        <a href="#" class="rts-btn btn-primary">İletişim</a>
                                        <div class="call-area">
                                            <div class="icon">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="banner-one-wrapper ptb--110">
                                    ...
                                    <div class="button-area-banner">
                                        <a href="#" class="rts-btn btn-primary">Hakkımızda</a>
                                        <div class="call-area">
                                            <div class="icon">
                                                <i class="fa-regular fa-phone-volume"></i>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="banner-one-wrapper ptb--110">
                                    ...
                                    <div class="button-area-banner">
                                        <a href="#" class="rts-btn btn-primary">Hizmetlerimiz</a>
                                        <div class="call-area">
                                            <div class="icon">
                                                <i class="fa-regular fa-phone-volume"></i>
                                            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="rts-single-project-one">
                    ...
                    <div class="project-inner">
                        <a href="#">
                            <h5 class="title">Lorem İpsum</h5>
                        </a>
                        <p class="disc">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                        </p>
                        <a href="#" class="rts-btn btn-seconday">Devamını Oku</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                ...
                <div class="about-one-left-wrapper   reveal-item overflow-hidden aos-init">
                    <div class="reveal-item overflow-hidden aos-init">
                        ...
                        <div class="left-detail-thumb">
                            ...
                            <a href="#" class="rts-read-more-2">Devamını Oku <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="home-tab-pane" aria-selected="true">Hakkımız
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                        data-bs-target="#profile-tab-pane" type="button" role="tab"
                                        aria-controls="profile-tab-pane" aria-selected="false">Vizyon
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="contact-tab" data-bs-toggle="tab"
                                        data-bs-target="#contact-tab-pane" type="button" role="tab"
                                        aria-controls="contact-tab-pane" aria-selected="false">İletişim
                                </button>
                            </li>
                        </ul>
                                ...
                                <div class="single-tab-content-one">
                                    ...
                                    <div class="jurney-from">
                                        <div class="left-jr">
                                            ...
                                            <span class="sub">Lorem İpsum</span>
                                        </div>
                                        <div class="right-jr">
                                            <div class="single">
                                    ...
                                    <a href="#" class="rts-btn btn-seconday">Bize Ulaşın</a>
                                </div>
                            </div>
                                    ...
                                    <div class="jurney-from">
                                        ...
                                        <div class="right-jr">
                                            <div class="single contact">
                                                ...
                                                <a href="#">+110 111 00 10</a>
                                            </div>
                                            <div class="single contact">
                                                <i class="fa-regular fa-envelope"></i>
                                                <a href="#">info@anse.com.tr</a>
                                            </div>
                                            <div class="single contact">
                                                <i class="fa-regular fa-location-dot"></i>
                                                <a href="#">Çankaya, Ankara</a>
                                            </div>
                                        </div>
                                    </div>
                                    <a href="#" class="rts-btn btn-seconday">Bize Ulaşın</a>
...
<div class="rts-project-one-area rts-section-gapBottom">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="title-wrapper-casestudies-one">
                    <div class="elecate-left-title" data-sal="slide-up" data-sal-delay="150" data-sal-duration="800">
                        <span>Anse Mimarlık İnşaat</span>
                        <h3 class="title animated fadeIn">Projeler</h3>
                    </div>
    ...
    <div class="container-full-screen">
        <div class="row mt--40">
            <div class="col-lg-12">
                <div class="main-wrapper-case-swiper-tab" style="overflow-x: hidden; padding: 12px 0;">
                    <div class="swiper case-tab-swipers">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="single-case-wrapper">
                                    <a href="#">
                                        <img class="main-2" src="assets/images/project/10.jpg" alt="projects-images">
                                    </a>
                                    <div class="content">
                                        <a href="#">
                                            <h5 class="title">Lorem İpsum</h5>
                            ...
                            <div class="swiper-slide">
                                <div class="single-case-wrapper">
                                    <a href="#">
                                        <img class="main-2" src="assets/images/project/11.jpg" alt="projects-images">
                                    </a>
                                    <div class="content">
                                        <a href="#">
                                            <h5 class="title">Lorem İpsum</h5>
                            ...
                            <div class="swiper-slide">
                                <div class="single-case-wrapper">
                                    <a href="#">
                                        <img class="main-2" src="assets/images/project/12.jpg" alt="projects-images">
                                    </a>
                                    <div class="content">
                                        <a href="#">
                                            <h5 class="title">Lorem İpsum</h5>
        ...
        <div class="row g-5 mt--10">
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="single-blog-area-one">
                    <a href="#" class="thumbnail">
                        <img src="assets/images/blog/01.jpg" alt="blog-post">
                    </a>
                    <div class="inner">
                        <div class="blog-top">
                            <span>By david Smith</span>
                            <span>03 Şubat, 2023</span>
                        </div>
                        <a class="title" href="#">
                            <h5 class="title">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </h5>
                        </a>
                        <a href="#" class="rts-btn btn-seconday">Devamını Oku
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="single-blog-area-one">
                    <a href="#" class="thumbnail">
                        <img src="assets/images/blog/02.jpg" alt="blog-post">
                    </a>
                    <div class="inner">
                        <div class="blog-top">
                            <span>By david Smith</span>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="single-blog-area-one">
                    <a href="#" class="thumbnail">
                        <img src="assets/images/blog/03.jpg" alt="blog-post">
                    </a>
                    <div class="inner">
                        <div class="blog-top">
                            <span>By david Smith</span>
